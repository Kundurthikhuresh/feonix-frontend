...
const PLATFORM_NODES = [
  ...
  { id: 'whatsapp', label: 'WhatsApp', color: 0x25d366, radius: 3.5 },
  { id: 'discord', label: 'Discord', color: 0x5865f2, radius: 4.1 },
  { id: 'webex', label: 'Cisco Webex', color: 0x00bceb, radius: 3.4 },
  { id: 'jitsi', label: 'Jitsi Meet', color: 0x1774fd, radius: 4.0 },
  { id: 'slackhuddles', label: 'Slack Huddles', color: 0xecb22e, radius: 3.7 },
  { id: 'loom', label: 'Loom Video', color: 0x625df5, radius: 4.2 },
  { id: 'gotomeeting', label: 'GoTo Meeting', color: 0xff7a00, radius: 3.6 },
  { id: 'whereby', label: 'Whereby', color: 0xff6b6b, radius: 3.8 },
