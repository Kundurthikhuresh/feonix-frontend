...
// close (fully hide), the Settings trigger, and End Interview.
export default function InterviewControls({
  ...
  return (
    <div className="pk-topbar-right">
      ...
      <button className="pk-hide-btn" onClick={onClose} title="Hide completely (Ctrl+Shift+H)" type="button">Hide</button>
